...
public:
	...
	{ 
		...
		HDC hdc = ::GetDC(NULL);
		m_hCaptionFont = CreateFont( -MulDiv(7, GetDeviceCaps(hdc, LOGPIXELSY), 72), 0, 0, 0, FW_NORMAL, FALSE, 0, 0, 0, 0, 0, 0, 0, "Verdana");
		m_hCaptionUnderlineFont = CreateFont( -MulDiv(7, GetDeviceCaps(hdc, LOGPIXELSY), 72), 0, 0, 0, FW_NORMAL, FALSE, TRUE, 0, 0, 0, 0, 0, 0, "Verdana");
		::ReleaseDC(NULL, hdc);
